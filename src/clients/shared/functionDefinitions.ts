...
export const builtinFunctionDefinitions: readonly FunctionDefinition[] = [
  {
    ...
    args: ["address"],
    commentDoc: ["// the 8-bit value at the specified address"],
  },
  {
    key: "word",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the 16-bit value at the specified address"],
  },
  {
    key: "tbyte",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the 24-bit value at the specified address"],
  },
  {
    key: "dword",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the 32-bit value at the specified address"],
  },
  {
    key: "bit0",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the least significant bit of the specified address"],
  },
  {
    key: "bit1",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
  ...
  },
  {
    ...
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the third least significant bit of the specified address"],
  },
  {
    key: "bit3",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
  ...
  },
  {
    ...
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the fifth least significant bit of the specified address"],
  },
  {
    key: "bit5",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the sixth least significant bit of the specified address"],
  },
  {
    key: "bit6",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
  ...
  },
  {
    ...
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the most significant bit of the specified address"],
  },
  {
    key: "bit",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
  ...
  },
  {
    ...
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the four least significant bits of the specified address"],
  },
  {
    key: "high4",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the four most significant bits of the specified address"],
  },
  {
    key: "bitcount",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the number of non-zero bits at the specified address"],
  },
  {
    key: "word_be",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the 16-bit big-endian value at the specified address"],
  },
  {
    key: "tbyte_be",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the 24-bit big-endian value at the specified address"],
  },
  {
    key: "dword_be",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["address"],
    commentDoc: ["// the 32-bit big-endian value at the specified address"],
  },
  {
    key: "float",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
  ...
  },
  {
    ...
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
    args: ["accessor"],
    commentDoc: ["// the last differing value of the specified address"],
  },
  {
    key: "bcd",
    url: "https://github.com/Jamiras/RATools/wiki/Accessing-Memory",
  ...
  },
  {
    ...
    args: ["address", "string", "length", "transform"],
    commentDoc: [
  ...
  },
  {
    ...
    args: ["array", "value"],
    commentDoc: ["// Appends `value` to the end of `array`."],
  },
  {
    key: "array_pop",
  ...
  },
  {
    ...
    args: ["array", "value"],
    commentDoc: ["// Returns `true` if `value` is found in `array`."],
  },
  {
    key: "array_reduce",
    url: "",
    args: ["inputs", "initial", "reducer"],
    commentDoc: ["// Undocumented"],
  },
  {
    key: "array_filter",
  ...
  {
    key: "field_map",
    url: "https://github.com/Jamiras/RATools/wiki/Built-in-Functions#field_mapinput-predicate",
    args: ["input", "predicate"],
    commentDoc: [
      "// Returns an array or dictionary generated by processing each field of `input` through `predicate`.",
      "// ",
      "// `inputs` is an instance of a class.",
      "// ",
      "// `predicate` is a function that accepts a two parameters (the field name and its value) and returns an expression or constant constructed from that input. The expressions returned by `predicate` are stored in the new array that is returned by `field_map`. If the return value is a dictionary with a single key/value pair, then the final result will be a dictionary containing all of the returned key/value pairs.",
    ],
  },
  {
  ...
  },
  {
    ...
    args: ["name", "expression", "dictionary", "fallback"],
    commentDoc: [
      "// `name` is the name to associate to the placeholder. ",
      "// ",
  ...
  },
  {
    ...
    args: ["name", "address", "dictionary", "fallback"],
    commentDoc: [
  ...
  },
  {
    ...
    args: ["condition", "format_string", "parameters"],
    commentDoc: [
